...
class FransiscaNajwa {
  ...
  final String focus    = "Embedded Systems & IoT";
  final bool   openTo   = true; // internship & freelance
  ...
  String get funFact => "I debug hardware with a multimeter AND gdb 🔬";
}
```
